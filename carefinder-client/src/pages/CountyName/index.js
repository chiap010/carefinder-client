...
class CountyName extends Component {
    ...
    handleChange(event) {
        ...
        { 
            ...
            let url = "http://mango.cs.uwp.edu:3000/api/v1/hospitals?county=" + this.state.searchValue
            // never use & to append
    ...
    render() {
      return (
        ...
        <div >
        <h1>Hospital List - Search by County Name</h1>
